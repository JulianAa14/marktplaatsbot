...
client.on("guildMemberAdd", member => {
    ...
    var role = member.guild.roles.cache.get('777599288569495593')
    ...
    var channel = member.guild.channels.cache.get('777597670310019112');
...
client.on("guildMemberRemove", member => {
    ...
    var channel = member.guild.channels.cache.get('777598347984371742');
...
client.on("ready", async () => {
    ...
    client.user.setActivity("Marktplaats", { type: "PLAYING" });
